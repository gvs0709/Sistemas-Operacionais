...
int prog1(){
    ...
    childPID = fork(); /* insira um comando para criar um subprocesso*/
    ...
    if(childPID > 0){ // Faça com que o processo pai execute este trecho de código
        ...
        printf("[PAI] Mensagem recebida 2: 'j = %s'\n", readbuffer);
